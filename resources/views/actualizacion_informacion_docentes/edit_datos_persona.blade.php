      ...
      $('select').select2();
                        ...
                        <div class="col-md-6 form-group input-group-sm">
                                ...
                                <div class="col-md-6 form-group input-group-sm">
                                    ...
                                    <select name="id_municipio_expedicion" id="municipio_expedicion" class="form-control" style="width:" required autocomplete  >
                                </select>
                                </div>
			  ...
			  $('#comunidad_indigena_cual').css('display', 'none');
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group input-group-sm ">
                                ...
                                <select name="codigo_municipio" id="codigo_municipio" class="form-control" style="width:" required autocomplete>
                                </select>
                            </div>
                            <div class="col-md-6 form-group input-group-sm">
