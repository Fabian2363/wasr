  ...
  <div class="pull-left breadcrumb_admin clear_both">
      ...
      <div class="pull-right">
          <ol class="breadcrumb">
              ...
              <li class="active">@lang('Actualización Información General')</li>
          </ol>
      </div>
  </div>
  <br>
                ...
                success: (response) => {
                    ...
                    if(!response.status){
                            ...
                            let row = `<tr>
                                            ...
                                            <td><a href="/actualizacion-hoja-vida/${btoa(response.result.id)}/documentos">Actualizar Mi Antecedentes Judiciales</a></td>
                                            <td><a href="/actualizacion-hoja-vida/${btoa(response.result.id)}/documentos-hoja-vida">Actualizar Mi Hoja de Vida</a></td>
                                            <td><a href="/Actualizacion-informacion-general/${btoa(response.result.id)}/actualizar">Actualizar Mi Informacion</a></td>
                                        </tr>`;
