...
<head>
    ...
    <title>
        {{ config('menu2.name', 'INFORMACION PERSONA INGRESADO EN SISTEMA TALENTO HUMANO-SITH') }}
    </title>
                                ...
                                <tbody>
                                    <tr bgcolor="#327bb2">
                                        <td colspan="4" class="subtitulo4" aling="center"> <br>
                                            <div aling="center">INFORMACIÓN GENERAL DE TALENTO HUMANO   </div><br>
                                        </td>
                                    </tr>
                                        ...
                                        <td colspan="4">
                                            <table width="95%" border="0" aling="center" cellpadding="0" cellspacing="1"
                                                ...
                                                <tbody>
                                                    <tr bgcolor="#849AC6">
                                                        <td colspan="2" height="25px" ; class="subtitulo4">
                                                            <div aling="center" class="Estilo16">Ver mi información Completa
                                                                 </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                            ...
                                                            <div aling="center" class="contenedor1">
                                                                ...
                                                                <a href="/Informacion_talento_humano">
                        <span class="boton3">Ver mi información Completa suministrado a SITH </span>
...
.boton3:hover {
    ...
    <script>
        $('#btnSeguirProceso').click(()=>{
            let array=location.href.split('/home');
            array.pop();
            array.pop();
            location.href=array.join("/home");
        });
    </script>
