...
<script>
  $(document).ready(function () {
      ...
      formPersona.submit((e) => { 
          ...
          $.ajax({
              type: "POST",
              url: "/Informacion_talento_humano",
              ...
              success: (response) => {
                  ...
                  if(!response.status){
                          ...
                          let row = `<tr>
                                          ...
                                          <td><a href="/Informacion_talento_humano/${(response.result.id)}/informacion_registrado">Ir A Ver Informacion</a></td>
                                      </tr>`;
