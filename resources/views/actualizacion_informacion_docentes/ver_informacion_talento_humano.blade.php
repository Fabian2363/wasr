    ...
    <style type="text/css">
                        ...
                        <td colspan="3">
                            ...
                            <table width="95%" border="0" aling="center" cellpadding="0" cellspacing="1"
                                ...
                                <tbody>
                                    ...
                                    <tr bgcolor="#FFFFFF">
                                        <td bgcolor="#ddd" class="subtitulo2"><strong>CORREO ELECTRONICO</strong></td>
                                        <td bgcolor="#FFF" class="subtitulo2">{{ $temp->email }}&nbsp;</td>
                                        <td bgcolor="#ddd" class="subtitulo2"><strong>INDIGENA</strong></td>
                                        <td bgcolor="#FFF" class="subtitulo2">{{ $temp->	comunidad_indigena_cual }}&nbsp;</td>
                                    </tr>
                                    <td bgcolor="#ddd" class="subtitulo2"><strong>FECHA EXPEDICION CC</strong></td>
                                        <td bgcolor="#FFF" class="subtitulo2">{{ $temp->fechaexpedicioncc }}&nbsp;</td>
                                        <td bgcolor="#ddd" class="subtitulo2"><strong>___</strong></td>
                                    ...
                                    <tr bgcolor="#849AC6">
                      <td colspan="4" class="tituloEtiqueta" align="center"> <div align="center">DIRECCIÓN - PERSONA </div></td>
                    </tr>
        ...
        <!--Aqui finaliza el codigo de tablas informacion trabajo-->
          ...
          <tr bgcolor="#849AC6">
                    ...
                    <tr bgcolor="#FFFFFF">
                  <td width="25%" bgcolor="#ddd" class="subtitulo2"><strong>ULTIMO NIVEL EDUCATIVO</strong></td>
                  <td width="23%" bgcolor="#FFF" class="subtitulo2">{{$temp->nivel_academico}}&nbsp;</td>
                  <td width="26%" bgcolor="#ddd" class="subtitulo2"><strong>NIVEL EDUCATIVO FORMACIÓN POSTGRADUAL</strong></td>
                  <td width="26%" bgcolor="#FFF" class="subtitulo2">{{$temp->postgradual }}&nbsp;</td> 
                </tr>

                <tr bgcolor="#FFFFFF">
                  <td width="25%" bgcolor="#ddd" class="subtitulo2"><strong>CARGO DE LA PERSONA</strong></td>
                  <td width="23%" bgcolor="#FFF" class="subtitulo2">{{$temp->nombre_esempeno}}&nbsp;</td>
                  <td width="26%" bgcolor="#ddd" class="subtitulo2"><strong>DIRECTOR DE GRADO</strong></td>
                  <td width="26%" bgcolor="#FFF" class="subtitulo2">{{$temp->director_grado }}&nbsp;</td> 
                  
                </tr>

                <tr bgcolor="#FFFFFF">
                  <td width="25%" bgcolor="#ddd" class="subtitulo2"><strong>GRADO QUE MANEJA COMO DIRECTOR</strong></td>
                  <td width="23%" bgcolor="#FFF" class="subtitulo2">{{$temp->nombre_grado}}&nbsp;</td>
                    ...
                    <tr bgcolor="#FFFFFF">
                      ...
                      <div class="row">           
                         <div id="educacionDiv" class="col-md-12 form-group" style="display: none;">
                                <input class="form-control" id="educacionInput" type="text" style="text-align: center;"   height="100" disabled>                                            
                        </div>
                        </div>
