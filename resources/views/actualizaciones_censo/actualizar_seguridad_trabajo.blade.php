    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="etiqueta2"> Actualizaraz .
                </div>
...
<div class="contenedor_informacion_persona">
                    ...
                    <div class="etiqueta2 ">Observaciones Formula medica.</div>
                    <textarea class="form-control" rows="3" name="observaciones_formula_medica" id="observaciones_formula_medica" placeholder="Ingrese Observaciones del empleado." onkeydown="valida_longitud(this.name)" onkeyup="valida_longitud(this.name)" onblur="valida_longitud(this.name)" =""></textarea>
                </div>
                        <div class="col-md-6 form-group input-group-sm">
                            <div class="etiqueta2">Anexar la foemula medica , recomendamos formato PDF . Tamaño
                                máximo de 5 Megabyte cada uno.</div>
                            <br>
                            

                        <div class="form-group input-group-sm">
                            <label><span class="asterisco">*</span>@lang('Cargar el documento (Furmula medica) formato PDF')</label>
                            <input type="file" id="formula_medica_pdf" name="formula_medica_pdf" class="btn-danger" accept=".pdf"  >
                        </div>
