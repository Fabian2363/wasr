    ...
    <div class="pull-left breadcrumb_admin clear_both">
        ...
        <div class="pull-right">
            <ol class="breadcrumb">
                ...
                <li class="active">Actualizar hoja de vida </li>
            </ol>
        </div>
    </div>
    <br>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="etiqueta2"> Actualizaraz hoja de vida.
                </div>
...
<div class="contenedor_informacion_persona">
                    ...
                    <div class="etiqueta2 ">Observaciones de la hoja de vida.</div>
                    <textarea class="form-control" rows="3" name="observaciones_hoja_vida" id="observaciones_hoja_vida" placeholder="Ingrese Observaciones del empleado." onkeydown="valida_longitud(this.name)" onkeyup="valida_longitud(this.name)" onblur="valida_longitud(this.name)" =""></textarea>
                </div>
                        ...
                        <div class="form-group input-group-sm">
                            <label><span class="asterisco">*</span>@lang('Cargar el documento (hoja de vida del empleado) formato PDF')</label>
                            <input type="file" id="hoja_vida_pdf" name="hoja_vida_pdf" class="btn-danger" accept=".pdf"  >
                        </div>
