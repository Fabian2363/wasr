    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="etiqueta2"> Actualizacion de información de contrato laboral.
                </div>
...
<div class="contenedor_informacion_persona">
                        ...
                        <div class="row separador">
                                                ...
                                                Información de contrato laboral:{{ $datos->nombres }}
                                                {{ $datos->apellidos }} CC N° {{ $datos->docomento_persona }}
                                                 ...
                                                 <div class="row">
                                                    <div class="col-md-3 form-group input-group-sm pull-left">
                                                        <div class="etiqueta2">Canasta </div>
                                                    ...
                                                    <div class="col-md-3 form-group input-group-sm pull-left">
                                                        <div class="etiqueta2">*Categoria Canasta </div>
                                                    ...
                                                    <div class="col-md-3 form-group input-group-sm pull-left">
                                                        ...
                                                        <select name="tipo_contrato" id="tipo_contrato" class="form-control" style="width:"
                                                            ...
                                                            <option value="Prestacion de Servicios(OPS)">Prestacion de Servicios(OPS)</option>
		                                 <option value="Contrato Laboral">Contrato Laboral</option>
		                                 <option value="Contrato YunØmareØp">Contrato YunØmareØp</option>
                                       ...
                                       <option value="Colfondos Pensiones y Cesantías S.A.">Colfondos Pensiones y Cesantías S.A.</option>
