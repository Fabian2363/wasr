...
-------------------------------
  <div class="contenedor_informacion_persona">
                    ...
                    <div class="recuadro_info_persona"> @lang('Actualizar direccion de residencia del empleado:') {{ $datos->nombres }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group input-group-sm pull-left">
                                ...
                                <select name="codigo_municipio" id="codigo_municipio" class="form-control" style="width:"  required="">
                                </select>
                            </div>
                            <div class="col-md-6 form-group input-group-sm">
                                <div class="etiqueta2">Barrio / Vereda.(*)</div>
                                <input type="text" id="direccion"  name="direccion"  onchange="Bus();" maxlength="50"
