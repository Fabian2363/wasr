...
<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        <h1> @lang('Consulta Hogar')</h1>
        <h2 class=""></h2>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="#"> @lang('Inicio')</a></li>
            <li><a href="#">@lang('Consulta Hogar')</a></li>
            <li class="active"></li>
        </ol>
    </div>
</div>
...
<div class="color_informacion_modulo " style="margin-top: 15px;">
    <span class="color_infor  ">@lang('Usted se encuentra en:') &nbsp;&nbsp;<font color="#060505"> @lang('Sistema de Informacion Poblacional Misak -SIPEMP') &gt; <font color="#060505">@lang('Consulta Hogar') </font> &gt; <font color="#060505">
            </font> </span>
</div>
              ...
              success: (response) => {
                  ...
                  if(!response.status){
                          ...
                          let row = `<tr>
                                          ...
                                          <td><a href="/Integrantes-hogar/${(response.result.hogar_id)}/Familia-Misak">Ver Familia</a></td>
                                      </tr>`;
