...
<div class="color_informacion_modulo " style="margin-top: 15px;">
    <span class="color_infor  ">@lang('Usted se encuentra en:')' &nbsp;&nbsp;<font color="#060505"> @lang('Sistema de Informacion Talento Humano') &gt; <font color="#060505">@lang('Consulta') </font> &gt; <font color="#060505">
            </font> </span>
</div>
                              ...
                              <form id="searchPersona" class="form_cunsulta" name="form" method="POST" role="informacion-perosona" class="pocicion_formulario">
                                  ...
                                  <div class="row" id="consulta_externa">
                                      <div class="col-md-12">
                                          ...
                                          value="{{ Auth::user()->cedula}}" style=""  type="number" required>
                                      </div>
                                  </div>
                    ...
                    <div class="block-web full">
                        <ul class="nav nav-tabs nav-justified nav_bg">
                            <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i
                                        class="fa fa-laptop"></i> @lang('Información del Habiatente')</a></li>
                        </ul>
              ...
              success: (response) => {
                  ...
                  if(!response.status){
                          ...
                          let row = `<tr>
                                          ...
                                          <td><a href="/Descargar-contratos/${(response.result.documento_persona)}">Ver Contratos</a></td>
                                      </tr>`;
