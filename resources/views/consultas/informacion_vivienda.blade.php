...
<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        <h1> @lang('Consulta Vivienda')</h1>
        <h2 class=""></h2>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="#"> @lang('Inicio')</a></li>
            <li><a href="#">@lang('Consulta Vivienda')</a></li>
            <li class="active"></li>
        </ol>
    </div>
</div>
...
<div class="color_informacion_modulo " style="margin-top: 15px;">
    <span class="color_infor  "> @lang('Usted se encuentra en:') &nbsp;&nbsp;<font color="#060505"> @lang('Sistema de Informacion Poblacional Misak -SIPEMP') &gt; <font color="#060505">@lang('Consulta Vivinda') </font> &gt; <font color="#060505">
            </font> </span>
</div>
                              ...
                              <form id="searchPersona" class="form_cunsulta" name="form" method="POST" role="informacion-perosona" class="pocicion_formulario">
                                  ...
                                  <div class="row" id="consulta_externa">
                                      <div class="col-md-12">
                                          ...
                                          value="{{ Auth::user()->id_persona}}"  type="number" required>
                                      </div>
                                  </div>
                                  <div class="user-button">
                                      <div class="row">
                                          <button class="botonBuscar" type="submit" id="boton" name="enviar"> @lang('Ver miembros del hogar')</button>
                                      </div>
                                  </div>
                              </form>
                      </div>
                    ...
                    <div class="block-web full">
                        <ul class="nav nav-tabs nav-justified nav_bg">
                            <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i
                                        class="fa fa-laptop"></i> @lang('Informacion Propietario Vivienda') </a></li>
                        </ul>
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table id="persona" class="table table-bordered table-striped">
                                                      <thead>
                                                          <tr>
                                                              <th> @lang('N° CEDULA') </th>
                                                              <th >@lang('TIPO DOCUMENTO') </th>
                                                              <th> @lang('NOMBRES')</th>
                                                              <th> @lang('APELLIDO')</th>
                                                              <th>@lang('PARENTESCO')</th>
                                                              <th>@lang('CODIGO VIVIENDA')</th>
              ...
              success: (response) => {
                  ...
                  if(!response.status){
                          ...
                          let row = `<tr>
                                          ...
                                          <td>${response.result.parentesco}</td>
                                          <td>${response.result.vivienda_id}</td>
                                          
                                       
                                          <td><a href="/Informacion-vivienda/${(response.result.vivienda_id)}/Vivienda-Misak">@lang('Ver Vivienda')</a></td>
                                      </tr>`;
