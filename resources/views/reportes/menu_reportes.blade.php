...
<main class="hg-bg-white">
        ...
        <div class="parallax nano-content" id="nano-content" tabindex="0" style="right: -17px;">
            <div class="pull-left breadcrumb_admin clear_both">
                <div class="pull-left page_title theme_color">
                    <h1> @lang('certificado')</h1>
                    <h2 class=""> @lang('Menu')</h2>
                </div>
                <div class="pull-right">
                    <ol class="breadcrumb">
                        <li><a href="#"> @lang('Inicio')</a></li>
                        <li><a href="#"> @lang('Certificado')</a></li>
    ...
    <span class="color_infor  ">@lang('Usted se encuentra en:') &nbsp;&nbsp;<font color="#060505"> @lang('Menu Certificados') &gt; <font color="#060505"> </font> &gt; <font color="#060505">
            </font> </span>
</div>
<br>
                        ...
                        <div id="PanelIzquierdoUC1_pnlConsultarLiquidacion"
                            ...
                            <div class="row">
                                ...
                                <i class="fas fa-list-ul"></i>
                                    <a href="{{ url('Buscar-Persona') }}">
                                        <h1>
                                           
                                            <i class="far fa-file-alt"></i>
                                            <class="icon_consulta"> 
                                        </h1>
                                         @lang('CERTIFICADO LABORAL')
                                    </a>
                                </div>
                            </div>
                    ...
                    <!--
                        <div id="PanelIzquierdoUC1_pnlReportes" class="hg-col col-sm-6 col-md-4 col-lg-3 text-center">
                            ...
                            <div class="row">
                                <div class="hg-menu-opcion">
                                    <i class="fas fa-list-ul"></i>
                                    <a href="{{ url('Listado-personas-fallecidos') }}" class="btn-menu-padre">
                                        <h1>
                                        <img  width=30px; src="icon/marketing.png" >
                                        </h1>
                                         @lang('LISTADO DE PERSONAS-FALLECIDOS')
                                    </a>
                                    <div class="clear"></div>
