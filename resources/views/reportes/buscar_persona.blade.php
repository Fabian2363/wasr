...
<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        <h1>@lang('Consulta Persona')</h1>
        <h2 class=""></h2>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="#">@lang('Inicio')</a></li>
            <li><a href="#">@lang('Consulta Persona ')</a></li>
            <li class="active"></li>
        </ol>
    </div>
</div>
...
<div class="color_informacion_modulo " style="margin-top: 15px;">
    <span class="color_infor  ">@lang('Usted se encuentra en:')' &nbsp;&nbsp;<font color="#060505"> @lang('Sistema de Informacion Talento Humano') &gt; <font color="#060505">@lang('Consulta Habiatente') </font> &gt; <font color="#060505">
            </font> </span>
</div>
                    ...
                    <div class="block-web full">
                        <ul class="nav nav-tabs nav-justified nav_bg">
                            <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i
                                        class="fa fa-laptop"></i> @lang('Información Persona')</a></li>
                        </ul>
                                                    ...
                                                    <table id="persona" class="table table-bordered table-striped">
                                                      <thead>
                                                          <tr>
                                                              ...
                                                              <th>@lang('NOMBRES')</th>
                                                              <th>@lang('APELLIDO')</th>
                                                              <th>@lang('DOCUMENTO PDF')</th>
                                                              <th>@lang('ACCI&Oacute;N')</th>
                                                          </tr>
                                                      </thead>
                                                      <tbody>
              ...
              success: (response) => {
                  ...
                  if(!response.status){
                          ...
                          let row = `<tr>
                                          ...
                                          <td><a href="/Certificados-Laborales/${(response.result.id)}">Generar Certificados-Laborales</a></td>
                                      </tr>`;
