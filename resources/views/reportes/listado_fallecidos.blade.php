...
<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        <h1>@lang('Reporte')</h1>
        <h2 class="">@lang('Listado de Personas Fallecidos')</h2>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="#">@lang('Inicio')</a></li>
            <li><a href="#">@lang('Reporte')</a></li>
            <li class="active">@lang('Listado de Personas Fallecidos')</li>
        </ol>
    </div>
</div>
...
<div class="color_informacion_modulo " style="margin-top: 15px;">
    <span class="color_infor  ">@lang('Usted se encuentra en:') &nbsp;&nbsp;<font color="#060505"> @lang('Sistema de Informacion Poblacional Misak -SIPEMP') &gt; <font color="#060505">@lang('Reportes ')</font> &gt; <font color="#060505">@lang('Listado de Personas Fallecidos')</font> </span>
</div>
        ...
        <div class="ContenedorFormularioCenso">
            <div class="panel-body">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="active"><a data-toggle="tab" href="#Tab1">@lang('Personas Fallecidos')</a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            @lang(' BUSCAR POR CC:')' <input id="searchTerm" type="number" onkeyup="doSearch()" />
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <h4>@lang('Listado de personas fallecidos  en el resguado de Guambia.')</h4>
