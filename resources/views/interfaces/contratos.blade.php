      ...
      <form id="censoPersona" method="POST" enctype="multipart/form-data">
		...
		<div class="recuadro_info_persona"> @lang('Información  de Item y Rubro Canasta ') {{ $datos->nombres }}
                    ...
                    <!--Contenedor informacion_persona --->
                        ...
                        <textarea class="form-control" rows="3" name="observaciones" id="txtObservacion" placeholder="Ingrese Observaciones del Contrato." onkeydown="valida_longitud(this.name)" onkeyup="valida_longitud(this.name)" onblur="valida_longitud(this.name)" =""></textarea>
                    </div>
                            <div class="col-md-6 form-group input-group-sm">
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <input type="file" id="documento_pdf" name="documento_pdf" class="btn-danger" style="width:300px" accept=".pdf"  required autocomplete>
                            </div>
...
let datosPersona = {!!($datos->status==1?1:$datosPersona)!!};
