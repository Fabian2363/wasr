...
<div class="myresume-wrapper js-myresume-wrapper ">
  <div class="myresume-info hidden-xs hidden-sm">
      <div class="myresume-info-content">
          ...
          <p>
              Tu <strong>Hoja de vida</strong> está al:
          </p>

          <div class="info-progress-column">
          ...
          <ul class="info-anchors js-professional-info-module">
              ...
              <li class="anchor-item js-personal-info-module-menu">
                  <a href="" datalayertag="">
...
<div class="hidden-xs">
          ...
          <div class="ups-text-pda-container pull-right">
            <img class="ups-text-pda-state" src="./blade_wasr/texto-nueva-prueba-hv-desktop.svg" alt="¡Ya conoces la nueva prueba!" title="¡Ya conoces la nueva prueba!" width="228" height="50">
          </div>
          <div class="panel panel-default pda-resume-panel-desktop">
            <div class="star-tape text-center">
              <i class="fa fa-user"></i>
            </div>
            <h1 class="pda-result-title-desktop">______</h1>
            <div class="panel-body">
                  <a class="btn center-block btn-secondary btn-features js-pda-test-bnt" href="" datalayertag="">
                ____
                  </a>
...
<div class="offer-item text-center js-related-offert-container" datalayertag="{&quot;event&quot;:&quot;productClick&quot;,&quot;ecommerce&quot;:{&quot;click&quot;:{&quot;actionField&quot;:{&quot;list&quot;:&quot;perfil usuario&quot;},&quot;products&quot;:[{&quot;name&quot;:&quot;desarrollador de software junior&quot;,&quot;id&quot;:&quot;1885915613&quot;,&quot;brand&quot;:&quot;Recomendacion - oferta - perfil usuario&quot;,&quot;category&quot;:&quot;oportunidades para ti&quot;,&quot;position&quot;:1,&quot;dimension7&quot;:&quot;Empresa confidencial&quot;,&quot;dimension21&quot;:&quot;$1,5 a $2 millones&quot;}]}}}">
    <div class="joboffer-recommended js-link-offer" data-offer-link="/co/ofertas-trabajo/desarrollador-de-software-junior/1885915613?icid=rec_hom-desarrollador-de-software-junior">
        <img class="joboffer-recommended-img hidden-xs hidden-sm" src="./Mi hoja de vida – elempleo.com_files/logo_pordefecto.gif" alt="Empresa confidencial" title="Empresa confidencial" width="100" height="47">

        <input type="hidden" value="1885915613" class="js-offer-id">
                 
        <div class="joboffer-companyname js-company-name" style="float: none; position: static;"><span>
                Empresa confidencial
            </span></div>

        <div class="joboffer-title">
            <a href="" title="desarrollador de software junior">
                <span class="visible-xs visible-md visible-lg">
        ...
        <div class="joboffer-salary js-salary">
            <span>
               ------
            </span>
        </div>

        <div class="joboffer-time">
  ...
  <div class="js-box-skills">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group input-group-sm">
                                <label for="genero"><span class="asterisco">*</span>@lang('Genero')</label>
                            ...
                            <div class="form-group input-group-sm">
                                <label><span class="asterisco">*</span>@lang('Tipo de sangre') </label>
                                <select id="tipo_sangra" name="tipo_sangra" type="text" class="form-control" required>
                                    <option value="">Seleccione</option>
                            ...
                            <div class="form-group input-group-sm">
                                <label><span class="asterisco">*</span>@lang('¿Cuál carnet de salud tiene?') </label>
                                <select id="carnet_salud_id" name="carnet_salud_id" id="servicio_acueducto" id="select2_example"  id="framework" class="form-control selectpicker" data-live-search="true"    required>
                            ...
                            <div class="form-group input-group-sm">
                                <label>
                                    ...
                                    <option value="">@lang('Seleccione Profesión Actual')</option>
      ...
      $('select').select2();
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group input-group-sm">
                                <label><span class="asterisco">*</span>@lang('Razón social')</label>
                                <select id="razon_social" name="razon_social" type="text" class="form-control" required>
                                    <option value="">Seleccione</option>
                            ...
                            <div class="form-group input-group-sm">
                                <label><span class="asterisco">*</span>@lang('Fecha Nacimiento')' </label>
                                   <input  Type ="date" id="fechanacimieto" name="fechanacimieto" placeholder="fechanacimieto"   class="form-control" type="number" maxlength="12" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  required>
                            </div>
                             <div class="form-group input-group-sm">
                                <label style="width:300px" for="title">@lang('Número Telefono:')</label>
                                <input id="telefono" name="telefono" placeholder="Teléfono"   class="form-control" type="number" maxlength="12" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  required>
                            </div>
							
                            <div class="form-group input-group-sm">
                                <label style="width:300px">@lang(' N° Contacto Emergencias')</label>
                                <input id="contacto_emergencia" name="contacto_emergencia" value="" placeholder="Número Telefono" type="number" class="form-control" autocomplete="off">
                            </div>
                ...
                <!--Fin del contenedor informacion_persona -->
					...
					<div class="recuadro_info_persona"> @lang('Información del Departamento, Municipio y Fecha de Expedición CC De') {{ $datos->nombres }}
                        </div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
					 <div class="row">
                                <div class="col-md-4 form-group input-group-sm">
                                   <div class="etiqueta2">@lang('D Expedicion CC. (*)')</div>
								  <select name="departamento" id="departamento_expedicion" class="form-control" style="width:"
                                    required="">
                                ...
                                <div class="col-md-4 form-group input-group-sm">
                                    <div class="etiqueta2">@lang('M de Expedicion CC.(*)')</div>
                               ...
                               <div class="col-md-4 form-group input-group-sm">
                                    ...
                                    <input type="date" id="fecha_expedicion" name="fechaexpedicioncc" placeholder="Ingrese fecha de nacimiento" class="form-control" required >
                                </div>
                            </div>
							<div class="recuadro_info_persona"> @lang('Información del Lugar de Residencia :') {{ $datos->nombres }}
                              </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-3 form-group input-group-sm pull-left">
                                ...
                                <select name="codigo_municipio" id="municipios" class="form-control" style="width:">
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 form-group input-group-sm">
                               ...
                               <select name="comunidad_indigena" id="comunidad_indigena" tabindex="51" class="form-control" onchange="shoIndigeana(this);" required autocomplete>
		                       <option value="">Seleccione</option>
