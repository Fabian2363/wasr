  ...
  <div class="pull-left breadcrumb_admin clear_both">
      <div class="pull-left page_title theme_color">
          ...
          <h2 class="">@lang('Actualización Documentación Hoja de vida')</h2>
      </div>
      <div class="pull-right">
          <ol class="breadcrumb">
              <li><a href="#">@lang('Inicio')</a></li>
              <li><a href="#">@lang('Actualización')</a></li>
              <li class="active">@lang('Actualización Información Hoja de Vida')</li>
          </ol>
      </div>
  </div>
  <br>
  ...
  <div class="color_informacion_modulo " style="margin-top: 15px;">
      <span class="color_infor  ">@lang('Usted se encuentra en:')' &nbsp;&nbsp;<font color="#060505"> @lang('|SITH Espiral Educacion') &gt; <font color="#060505">Actualización </font> &gt; <font color="#060505">
      @lang('Actualización Información Hoja de Vida')</font> </span>
  </div>
                                ...
                                <form id="searchPersona" class="form_cunsulta" name="form" method="POST" role="informacion-perosona" class="pocicion_formulario">
                                    ...
                                    <div class="row" id="consulta_externa">
                                        <div class="col-md-12">
                                            ...
                                            value="{{ Auth::user()->cedula}}" style="visibility:hidden"  type="number" required>
                                        </div>
                                    </div>
                                    <div class="user-button">
                                        <div class="row">
                                            <button class="botonBuscar" type="submit" id="boton" name="enviar">@lang('Ver información General')</button>
                                        </div>
                                    </div>
                                </form>
                        </div>
                      ...
                      <div class="block-web full">
                          <ul class="nav nav-tabs nav-justified nav_bg">
                              <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i
                                          class="fa fa-laptop"></i>@lang('Información General') </a></li>
                          </ul>
                                                      ...
                                                      <table id="persona" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>@lang('NOMBRES')</th>
                                                                <th>@lang('APELLIDO')</th>
                                                                <th>@lang('ESTADO CIVIL')</th>
                                                                <th>@lang('VER HOJA DE VIDA')</th>
                                                                <th>@lang('ACTUALIZAR')</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
...
<script>
    $(document).ready(function () {
        ...
        formPersona.submit((e) => { 
            ...
            $.ajax({
                type: "POST",
                url: "/Actualizacion-informacion-talento-humano",
                ...
                success: (response) => {
                    ...
                    if(!response.status){
                            ...
                            let row = `<tr>
                                            ...
                                            <td>${response.result.tipo_identificacion}</td>
                                            <td>${response.result.nombres}</td>
                                            <td>${response.result.apellidos}</td>  
                                            <td>${response.result.estado_civil}</td>
                                            <td><button class="enlace" onclick="decargarDoc(${response.result.id});">Descargar Hoja de Vida</button></td>
                                            <td><a href="/actualizacion-hoja-vida/${btoa(response.result.id)}/documentos">Actualizar Mi Informacion</a></td>
                                        </tr>`;
