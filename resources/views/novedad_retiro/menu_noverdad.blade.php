...
<main class="hg-bg-white">
    ...
    <span class="color_infor  ">@lang('Usted se encuentra en:') &nbsp;&nbsp;<font color="#060505">@lang('Menu Novedades')  &gt; <font color="#060505"> </font> &gt; <font color="#060505">
            </font> </span>
</div>
<br>
                    ...
                    <div class="row hg-menu-principal-contenedor">
                          ...
                          class="hg-col col-sm-6 col-md-4 col-lg-3 text-center">
                            ...
                            <div class="row">
                                ...
                                <i class="fas fa-list-ul"></i>
                                    <a href="{{ url('Buscar-Persona-Fallecido') }}">
                                        <h1>
                                           
                                        <img  width=30px; src="icon/marketing.png" 
                                            <class="icon_consulta"> 
                                        </h1>
                                         @lang('NOVEDAD DE RETIRO POR FALLECIMIENTO')
                                    </a>
                                </div>
                            </div>
                        ...
                        <div id="PanelIzquierdoUC1_pnlConsultarLiquidacion"
                            ...
                            <div class="row">
                                <div class="hg-menu-opcion">
                                <i class="fas fa-list-ul"></i>
                                    <a href="{{ url('Buscar-Persona-Retirar') }}">
                                        <h1>
                                        <img width=30px; src="icon/informacion.png" class="icon_consulta">
                                        </h1>
                                         @lang('NOVEDAD -CANCELAR CONTRATO LABORAL')
                                    </a>
                                </div>
                            </div>
                        ...
                        <div id="PanelIzquierdoUC1_pnlReportes" class="hg-col col-sm-6 col-md-4 col-lg-3 text-center">
                            ...
                            <div class="row">
                                <div class="hg-menu-opcion">
                                    <i class="fas fa-list-ul"></i>
                                    <a href="{{ url('Buscar-Persona-Retirar') }}" class="btn-menu-padre">
                                        <h1>
                                        <img  width=30px; src="icon/marketing.png" >
                                        </h1>
                                         @lang('RETIRRADOS DEL CENSO -FALLECIDOS')
                                    </a>
                                    <div class="clear"></div>
