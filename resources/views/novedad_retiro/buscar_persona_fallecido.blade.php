...
<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        ...
        <h2 class="">@lang('Buscar Persona Fallecida')</h2>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="#">@lang('Inicio')</a></li>
            <li><a href="#"> @lang('Novedad Retiro')</a></li>
            <li class="active">@lang('Buscar Persona Fallecida')</li>
        </ol>
    </div>
</div>
...
<div class="color_informacion_modulo " style="margin-top: 15px;">
    <span class="color_infor  ">@lang('Usted se encuentra en:')' &nbsp;&nbsp;<font color="#060505"> @lang('Sistema de Información  Poblacional Misak | SIPEMP') &gt; <font color="#060505">@lang('Novedad Retiro') </font> &gt; <font color="#060505">
    @lang(' Buscar Persona Fallecida')</font> </span>
</div>
            ...
            <div class="col-md-4">
                <div class="profile_bg">
                    ...
                    <div class="account-status-data">
                        <h5>@lang('Ingrese documento de la persona fallecida')</h5>
                    ...
                    <div class="block-web full">
                        <ul class="nav nav-tabs nav-justified nav_bg">
                            <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i
                                        class="fa fa-laptop"></i>@lang('Información de la persona fallecida') </a></li>
