...
<div class="pull-left breadcrumb_admin clear_both">
    ...
    <div class="pull-right">
        <ol class="breadcrumb">
            ...
            <li><a href="#">@lang('cancelacion de contratos laborales')</a></li>
        ...
        <div class="ContenedorFormularioCenso">
            <div class="color_infor noPrint" style="margin-top: 15px;">
                <span class="color_infor  noPrint">@lang('Usted se encuentra en:')&nbsp;&nbsp;@lang('Contratos Laborales') &gt; <font
                        color="#666666">@lang('Cancelacion de contratos laborales') </font></span>
            </div>
                            ...
                            <tr> 
                               <td>{{$key+1}}</td>
                                ...
                                <td><button class="enlace" 
                                        onclick="cambiarEstado({{ $novedad->id }});">{{ $novedad->estado==0?'Retirar':'Reingresar' }}</button>
                                </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">Retiro e ingreso  del  censo poblacion  Misak- SIPEMP</h5>
            </div>
            <div class="modal-body">
                <p>¿Esta  seguro  de  realizar esta accion con el  habiatente: 
                                {{ $novedad->nombres }}-
                                {{ $novedad->apellidos }} Identificado con: 
                                {{ $novedad->docomento_persona }} ?</p>
            </div>
